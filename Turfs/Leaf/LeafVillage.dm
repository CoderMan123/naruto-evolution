...
turf
	Villages
		TsuchikageHouse
			density=1
			icon='TsuchikageHouse.dmi'

		MizukageHouse
			density=1
			icon='MizukageHouse.dmi'
		TutorialHouse
			density=1
			icon='TutorialHouse.dmi'
	LeafVillage3
		icon='GRND.dmi'
		Statues2
			Arms
		...
		Hospital
			...
			Windows
				WindowSill
					icon_state="windowsill"
				WindowSill2
					icon_state="windowsill2"
				Window3
					icon_state="Window3"
				Window2
					icon_state="Window2"
