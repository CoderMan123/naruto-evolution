client
	verb
		...
		keybind_call(input as text)
			...
			else if(hotkey_handsealactivate == input) 										src.mob.Activate_Handseals()//HandSealActivate()
			else if(hotkey_handseal_rat == input) 											src.mob.Handseal_Pressed("rat")
			else if(hotkey_handseal_snk == input) 											src.mob.Handseal_Pressed("snake")
			else if(hotkey_handseal_hrs == input) 											src.mob.Handseal_Pressed("horse")
			else if(hotkey_handseal_mky == input) 											src.mob.Handseal_Pressed("monkey")
			else if(hotkey_handseal_drg == input) 											src.mob.Handseal_Pressed("dragon")
			else if(hotkey_handseal_dog == input) 											src.mob.Handseal_Pressed("dog")
			else if(hotkey_handseal_rbt == input) 											src.mob.Handseal_Pressed("rabbit")
			else if(hotkey_handseal_ox == input) 											src.mob.Handseal_Pressed("ox")
