		...
		Entered(mob/M)
			...
			if(istype(M,/mob))
				if(M.stepcounter==3&&M.speeddelay==2)
					M.stepcounter=0
					if(M.foot=="Left")
						view(M,6) << sound('Walk/grassl.ogg',0,0,0,25)
						M.foot="Right"
					else
						if(M.foot=="Right")
							view(M,6) << sound('Walk/grassr.ogg',0,0,0,25)
							M.foot="Left"
				else
		...
		Entered(var/mob/M)
			if(istype(M,/mob))
				...
				if(M.stepcounter==3&&M.speeddelay==2)
					M.stepcounter=0
					if(M.foot=="Left")
						view(M,6) << sound('Walk/man_fs_l_mt_con.ogg',0,0,0,25)
						M.foot="Right"
					else
						if(M.foot=="Right")
							view(M,6) << sound('Walk/man_fs_r_mt_con.ogg',0,0,0,25)
							M.foot="Left"
				else
					if(M.stepcounter==5&&M.speeddelay==1.5)
						M.stepcounter=0
				...
				if(istype(M,/mob))
					if(M.injutsu==0&&M.dashable<>2)
						if(M.stepcounter==3&&M.speeddelay==2)
							M.stepcounter=0
							if(M.foot=="Left")
								view(M,6) << sound('Walk/man_fs_l_mt_snd.ogg',0,0,0,25)
								M.foot="Right"
							else
								if(M.foot=="Right")
									view(M,6) << sound('Walk/man_fs_r_mt_snd.ogg',0,0,0,25)
									M.foot="Left"
						else
							if(M.stepcounter==5&&M.speeddelay==1.5)
								M.stepcounter=0
				...
				if(istype(M,/mob))
					if(M.injutsu==0&&M.dashable<>2)
						if(M.stepcounter==5)
							M.stepcounter=0
							if(M.foot=="Left")
								view(M,6) << sound('Walk/man_fs_l_mt_wat.ogg',0,0,0,25)
								M.foot="Right"
							else
								if(M.foot=="Right")
									view(M,6) << sound('Walk/man_fs_l_mt_wat.ogg',0,0,0,25)
				...
				if(istype(M,/mob))
					if(M.injutsu==0&&M.dashable<>2)
						if(M.stepcounter==3&&M.speeddelay==2)
							M.stepcounter=0
							if(M.foot=="Left")
								view(M,6) << sound('Walk/man_fs_l_mt_drt.ogg',0,0,0,25)
								M.foot="Right"
							else
								if(M.foot=="Right")
									view(M,6) << sound('Walk/man_fs_r_mt_drt.ogg',0,0,0,25)
									M.foot="Left"
						else
							if(M.stepcounter==5&&M.speeddelay==1.5)
								M.stepcounter=0
