	...
	proc
		...
		Susanoo()
			for(var/obj/Jutsus/Susanoo/J in src.JutsusLearnt)
				/*if(src.Susanoo)
					src<<output("You deactivate your Susanoo","actionoutput")
					src.Susanoo = 0
					del(Susanoo)
					return */
				if(src.Sharingan<=3)
		...
		//		if(!src.Susanoo)
				...
				/*	while(Susanoo)
						...
						if(src.chakra<=0)
							src.chakra=0
							src<<output("Your Susanoo has deactivated","actionoutput")
							src.Susanoo = 0
							del(M)
							return */
					...
					if(src.PreJutsu(J))
						...
						while(src.Sharingan)//?
							...
							if(src.chakra<=0)
								src.chakra=0
								src.Sharingan=0
								src << output("<font color=[colour2html("red")]><b>Your sharingan has been deactivated.","actionoutput")
								//if(src.jutsucopy)src.jutsucopy=0
